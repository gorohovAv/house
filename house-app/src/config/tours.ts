  ...
  steps: [
    {
      ...
      description:
        'Пришло время воплотить ваши планы в жизнь! Добро пожаловать на самый <b>динамичный и непредсказуемый этап</b> — этап строительства.<br><br><br><div class="tour-construction-features"><b>Что вас ждёт:</b><br><div class="tour-feature-item">⚠️ <b>Реальные риски.</b> Стройка полна сюрпризов! Вам придётся сталкиваться с непредвиденными ситуациями и выбирать, как на них реагировать. Каждое решение повлияет на бюджет или сроки.</div><div class="tour-feature-item">📊 <b>Живой контроль.</b> Следите за ключевыми показателями: от текущего баланса до прогноза по итоговой стоимости. Ваш дом будет "расти" на глазах, а метрики подскажут, всё ли идёт по плану.</div><div class="tour-feature-item">🔄 <b>Гибкость.</b> Жизнь внесла коррективы? Не беда! Вы сможете оперативно менять ещё не начатые элементы, чтобы уложиться в рамки.</div><div class="tour-feature-item">💰 <b>Управление ресурсами.</b> Если запланированных денег вдруг перестало хватать — вы можете запросить дополнительное финансирование (в разумных пределах, конечно!).</div></div><br><br><div class="tour-mission">🎯 <b>Ваша главная задача:</b> Провести проект от фундамента до крыши, минимизируя потери и принимая взвешенные решения. Чем меньше отклонения — тем выше ваш проект окажется в рейтинге. Удачи!</div>',
      type: "modal",
      //position: "center",
    },
    {
