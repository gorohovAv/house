  ...
  const renderDescriptionStep = () => (
    <div className="onboarding-description">
      <div className="onboarding-content">
        <p>
          Вы стали руководителем собственного строительного проекта! Ваша задача
          — не просто построить дом, а сделать это блестяще: уложиться в бюджет,
          соблюсти сроки и справиться со всеми неожиданностями, которые
          приготовила вам стройка. Вас ждёт увлекательный путь из двух ключевых
          этапов: Планирование: где вы создадите идеальный план. Строительство:
          где вы воплотите его в жизнь, принимая смелые решения. Это ваш проект,
          ваши правила. Проявите стратегическое мышление, будьте внимательны к
          деталям! Удачи!
        </p>
      </div>
    </div>
